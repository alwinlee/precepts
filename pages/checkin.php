...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">受戒學員報到登錄</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8" align="left">
                        ...
                        <input type="checkbox" class="sx-checkbox" id="autocheckin" name="autocheckin">&nbsp;&nbsp;若是輸入報到條碼且剛好找到一位受戒學員時，就自動報到。
                        </label>
                        </div>
                    </div>
                    <div class="col-lg-2" align="center"></div>
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">報到登錄</h4>
                          </div>
                    ...
                    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="statusCancel">
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myModalLabel">報到取消</h4>
                          </div>
                          <div class="modal-body text-center">
                            成功!
                          </div>
    ...
    <script src="../resource/js/checkin.js?{D6477554-DAA6-4C24-A6EA-A8E238F91AA6}" type="text/javascript" charset="utf-8"></script>
</body>
